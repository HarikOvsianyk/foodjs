...
function forms(formSelector, modalTimerId) {
  ...
  function bindpostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_8__["postData"])('http://localhost:3000/requests', json).then(function (data) {
        console.log(data);
  ...
  function showThanksModal(message) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_7__["openModal"])('.modal', modalTimerId);
    ...
    setTimeout(function () {
      ...
      Object(_modal__WEBPACK_IMPORTED_MODULE_7__["closeModal"])('.modal');
    }, 4000);
  }
}
...
function openModal(modalSeletor, modalTimerId) {
  var modal = document.querySelector(modalSeletor);
...
function modal(triggerSelector, modalSeletor, modalTimerId) {
  ...
  modalTrigger.forEach(function (btn) {
    btn.addEventListener('click', function () {
      return openModal(modalSeletor, modalTimerId);
    });
  });
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2021-04-27');
});
